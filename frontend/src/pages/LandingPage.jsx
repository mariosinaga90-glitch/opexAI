  ...
  return (
    <div className="app-container" style={{ minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, height: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '0 1rem' }}>
        <div className="badge animate-fade-in-up" style={{ marginBottom: '1.5rem', display: 'inline-block', padding: '0.5rem 1rem', background: 'linear-gradient(90deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.2) 50%, rgba(255, 255, 255, 0.1) 100%)', backgroundSize: '200% auto', color: '#FFFFFF', borderRadius: '9999px', fontSize: '0.875rem', fontWeight: 600, border: '1px solid rgba(255, 255, 255, 0.25)', animation: 'shimmer 3s infinite linear' }}>✨ OpexTac Internal Tool</div>
        ...
        <button 
          ...
          style={{ padding: '1rem 3rem', fontSize: '1.15rem', borderRadius: '12px', boxShadow: '0 8px 24px rgba(255, 255, 255, 0.25)' }} 
