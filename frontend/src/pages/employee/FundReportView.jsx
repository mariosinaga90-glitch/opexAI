...
import { UploadCloud, Plus, Trash2, ArrowLeft, FileText, Download, X, Search, Filter } from 'lucide-react';
              ...
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                ...
                {selectedReport.photo && (!selectedReport.attachments || selectedReport.attachments.length === 0) && (
                  <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden', display: 'inline-block', padding: '0.5rem', background: 'rgba(0,0,0,0.02)' }}>
                    <img src={getFileUrl(selectedReport.photo)} alt="Bukti" style={{ maxWidth: '100%', maxHeight: '400px', objectFit: 'contain', display: 'block' }} />
                  </div>
                )}
              </div>
            </div>
      ...
      <div className="data-section glass-panel">
        <div className="section-header" style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1.5rem' }}>
          <div className="search-input" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', width: '300px' }}>
            ...
            <input 
              type="text" 
              placeholder="Cari ID atau Terkait Pengajuan..." 
