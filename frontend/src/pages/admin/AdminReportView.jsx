          ...
          try {
            ...
            for (let i = 0; i < filteredReps.length; i++) {
              ...
              const row = sheet.addRow({
                ...
                reqDate: detail?.requestDate ? formatDate(detail.requestDate) : '-',
                transferDate: detail?.items?.length > 0 && detail.items[0].transferDate ? formatDate(detail.items[0].transferDate) : '-',
                reportDate: rep.date || rep.createdAt ? formatDate(rep.date || rep.createdAt) : '-',
                status: rep.status || '-',
                photo: ''
              });
