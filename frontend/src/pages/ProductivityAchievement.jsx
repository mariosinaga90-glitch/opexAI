                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', color: 'white', fontSize: '0.75rem' }}>
                    <thead>
                      <tr>
                        ...
                        <th style={{ position: 'sticky', top: 0, right: 0, zIndex: 3, backgroundColor: '#0f172a', padding: '0.4rem 0.6rem', textAlign: 'center', fontWeight: 'bold', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>Total</th>
                      </tr>
                    </thead>
                    <tbody>
                      {productivityTeamData.data.map((row, idx) => {
                        ...
                        return (
                          <tr key={idx} style={{ backgroundColor: rowBg }}>
                            ...
                            <td style={{ position: 'sticky', right: 0, zIndex: 1, backgroundColor: rowBg, padding: '0.4rem 0.6rem', textAlign: 'center', fontWeight: 'bold', borderBottom: '1px solid rgba(255,255,255,0.1)', color: '#10b981' }}>{row.Total}</td>
                          </tr>
                        );
                      })}
                      {productivityTeamData.data.length > 0 && (
                        <tr style={{ backgroundColor: '#1e293b', fontWeight: 'bold' }}>
                          ...
                          <td style={{ position: 'sticky', bottom: 0, right: 0, zIndex: 3, backgroundColor: '#1e293b', padding: '0.4rem 0.6rem', textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
